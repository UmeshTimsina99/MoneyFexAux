...
class AddCashPickupRecipientPage extends StatefulWidget {
  AddCashPickupRecipientPage({
    Key? key,
  }) : super(key: key);

  @override
  _AddCashPickupRecipientPageState createState() =>
      _AddCashPickupRecipientPageState();
}

class _AddCashPickupRecipientPageState
    extends State<AddCashPickupRecipientPage> {
