...
class IdentityCheckInSuccessPage extends StatefulWidget {
  Widget? bodyConTent;
  Widget? bodySubConTent;
  Widget? bodySubConTentone;
  Widget bodyConTitle;
  Widget? upperContent;
  ...
  IdentityCheckInSuccessPage({
    this.upperContent,
    required this.bodyConTitle,
    this.bodyConTent,
    this.bodySubConTent,
    this.bodySubConTentone,
  ...
  @override
  _IdentityCheckInSuccessPageState createState() =>
      _IdentityCheckInSuccessPageState();
}

class _IdentityCheckInSuccessPageState
    extends State<IdentityCheckInSuccessPage> {
  @override
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 0),
          SizedBox(child: widget.bodySubConTentone),
          SizedBox(height: 15),
        ],
      ),
    );
